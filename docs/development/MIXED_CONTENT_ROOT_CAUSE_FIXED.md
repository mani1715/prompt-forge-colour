...
# CORS Configuration  
CORS_ORIGINS=https://forge-prompt.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://forge-prompt.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://forge-prompt.preview.emergentagent.com/api/client/projects`
...
When you access: `https://forge-prompt.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://forge-prompt.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://forge-prompt.preview.emergentagent.com` (production)

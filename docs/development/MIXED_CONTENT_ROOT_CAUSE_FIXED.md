...
# CORS Configuration  
CORS_ORIGINS=https://mani-code-repo.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://mani-code-repo.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://mani-code-repo.preview.emergentagent.com/api/client/projects`
...
When you access: `https://mani-code-repo.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://mani-code-repo.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://mani-code-repo.preview.emergentagent.com` (production)

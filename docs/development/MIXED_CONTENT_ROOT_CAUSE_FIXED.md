...
1. **User loads page**: `https://build-helper-16.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://build-helper-16.preview.emergentagent.com/api/client/projects`
...
When you access: `https://build-helper-16.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://build-helper-16.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://build-helper-16.preview.emergentagent.com` (production)

...
# CORS Configuration  
CORS_ORIGINS=https://color-fusion-web.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://color-fusion-web.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://color-fusion-web.preview.emergentagent.com/api/client/projects`
...
When you access: `https://color-fusion-web.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://color-fusion-web.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://color-fusion-web.preview.emergentagent.com` (production)

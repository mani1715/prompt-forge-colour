...
1. **User loads page**: `https://testimonial-app-1.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://testimonial-app-1.preview.emergentagent.com/api/client/projects`
...
When you access: `https://testimonial-app-1.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://testimonial-app-1.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://testimonial-app-1.preview.emergentagent.com` (production)

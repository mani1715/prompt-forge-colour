...
- **Page URL**: `https://testimonial-app-1.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://testimonial-app-1.preview.emergentagent.com`
- API calls go to: `https://testimonial-app-1.preview.emergentagent.com/api`

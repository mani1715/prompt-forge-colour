...
- **Page URL**: `https://dev-snippets.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://dev-snippets.preview.emergentagent.com`
- API calls go to: `https://dev-snippets.preview.emergentagent.com/api`

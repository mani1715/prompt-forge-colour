...
✅ **Production (HTTPS)**: API calls use `https://build-helper-16.preview.emergentagent.com/api/...`
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://build-helper-16.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://build-helper-16.preview.emergentagent.com/api/client/projects \

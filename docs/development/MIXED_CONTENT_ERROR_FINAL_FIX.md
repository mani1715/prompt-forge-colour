...
✅ **Production (HTTPS)**: API calls use `https://project-hub-231.preview.emergentagent.com/api/...`
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://project-hub-231.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://project-hub-231.preview.emergentagent.com/api/client/projects \

...
1. Navigate to: `https://mani-code-repo.preview.emergentagent.com/client/login`
...
3. **Check Network Tab** (F12 → Network tab)
   - All requests should be to `https://mani-code-repo.preview.emergentagent.com/api/...`
   - ❌ No requests should use `http://` protocol

#### C. Verify Data Syncing
1. Keep client dashboard open
2. In another tab, open admin panel: `https://mani-code-repo.preview.emergentagent.com/admin/login`
...
#### A. Home Page
1. Navigate to: `https://mani-code-repo.preview.emergentagent.com/`
...
```
[API Config] Base URL constructed: https://mani-code-repo.preview.emergentagent.com/api
[API Request] GET /client/projects Base: https://mani-code-repo.preview.emergentagent.com/api
[API Request] POST /admin/clients Base: https://mani-code-repo.preview.emergentagent.com/api
```
...
### Client Login
- URL: `https://mani-code-repo.preview.emergentagent.com/client/login`

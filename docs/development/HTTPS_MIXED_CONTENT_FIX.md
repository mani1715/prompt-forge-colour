...
### Error Message
```
Mixed Content: The page at 'https://build-helper-16.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://build-helper-16.preview.emergentagent.com`): Uses `/api` → converted to `https://build-helper-16.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://build-helper-16.preview.emergentagent.com,https://build-helper-16.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://build-helper-16.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://build-helper-16.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://build-helper-16.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://build-helper-16.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://build-helper-16.preview.emergentagent.com`

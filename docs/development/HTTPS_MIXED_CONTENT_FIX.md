...
### Error Message
```
Mixed Content: The page at 'https://forge-prompt.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://forge-prompt.preview.emergentagent.com`): Uses `/api` → converted to `https://forge-prompt.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://forge-prompt.preview.emergentagent.com,https://forge-prompt.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://forge-prompt.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://forge-prompt.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://forge-prompt.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://forge-prompt.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://forge-prompt.preview.emergentagent.com`

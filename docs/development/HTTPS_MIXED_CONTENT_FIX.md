...
### Error Message
```
Mixed Content: The page at 'https://color-fusion-web.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://color-fusion-web.preview.emergentagent.com`): Uses `/api` → converted to `https://color-fusion-web.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://color-fusion-web.preview.emergentagent.com,https://color-fusion-web.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://color-fusion-web.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://color-fusion-web.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://color-fusion-web.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://color-fusion-web.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://color-fusion-web.preview.emergentagent.com`

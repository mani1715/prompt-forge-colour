...
```
Page: https://dev-snippets.preview.emergentagent.com/client/dashboard
API Call: /client/projects
Result: https://dev-snippets.preview.emergentagent.com/api/client/projects
...
- [ ] Navigate to: `https://dev-snippets.preview.emergentagent.com/client/dashboard`
...
**Next Step**: Please test in your browser at `https://dev-snippets.preview.emergentagent.com` and verify:

...
### Error Message
```
Mixed Content: The page at 'https://api-secure-update.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://api-secure-update.preview.emergentagent.com`): Uses `/api` → converted to `https://api-secure-update.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://api-secure-update.preview.emergentagent.com,https://api-secure-update.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://api-secure-update.preview.emergentagent.com/admin/login`
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://api-secure-update.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://api-secure-update.preview.emergentagent.com`

...
- **Production HTTPS** (`https://error-patrol-5.preview.emergentagent.com`): Uses `/api` → converted to `https://error-patrol-5.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://error-patrol-5.preview.emergentagent.com,https://error-patrol-5.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://error-patrol-5.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://error-patrol-5.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://error-patrol-5.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://error-patrol-5.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://error-patrol-5.preview.emergentagent.com`

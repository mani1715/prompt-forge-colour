...
### Error Message
```
Mixed Content: The page at 'https://admin-panel-repair-13.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://admin-panel-repair-13.preview.emergentagent.com`): Uses `/api` → converted to `https://admin-panel-repair-13.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://admin-panel-repair-13.preview.emergentagent.com,https://admin-panel-repair-13.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://admin-panel-repair-13.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://admin-panel-repair-13.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://admin-panel-repair-13.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://admin-panel-repair-13.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://admin-panel-repair-13.preview.emergentagent.com`

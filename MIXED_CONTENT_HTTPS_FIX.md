...
- **Page URL**: `https://code-medic-35.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://code-medic-35.preview.emergentagent.com`
- API calls go to: `https://code-medic-35.preview.emergentagent.com/api`

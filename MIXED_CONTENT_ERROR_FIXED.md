...
1. **Frontend page loads** over HTTPS: `https://webcode-deploy.preview.emergentagent.com/client/dashboard`
2. **API request is made** with relative URL: `/api/client/projects/`
3. **Browser automatically constructs** the full URL using the current protocol: `https://webcode-deploy.preview.emergentagent.com/api/client/projects/`
...
Visit: `https://webcode-deploy.preview.emergentagent.com/client/dashboard`

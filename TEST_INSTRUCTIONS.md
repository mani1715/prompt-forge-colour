...
1. Navigate to: `https://api-secure-update.preview.emergentagent.com/client/login`
...
3. **Check Network Tab** (F12 → Network tab)
   - All requests should be to `https://api-secure-update.preview.emergentagent.com/api/...`
   - ❌ No requests should use `http://` protocol

#### C. Verify Data Syncing
1. Keep client dashboard open
2. In another tab, open admin panel: `https://api-secure-update.preview.emergentagent.com/admin/login`
...
#### A. Home Page
1. Navigate to: `https://api-secure-update.preview.emergentagent.com/`
...
```
[API Config] Base URL constructed: https://api-secure-update.preview.emergentagent.com/api
[API Request] GET /client/projects Base: https://api-secure-update.preview.emergentagent.com/api
[API Request] POST /admin/clients Base: https://api-secure-update.preview.emergentagent.com/api
```
...
### Client Login
- URL: `https://api-secure-update.preview.emergentagent.com/client/login`

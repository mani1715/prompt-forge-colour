...
✅ **Production (HTTPS)**: API calls use `https://secure-api-fix-1.preview.emergentagent.com/api/...`
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://secure-api-fix-1.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://secure-api-fix-1.preview.emergentagent.com/api/client/projects \

...
- Frontend was loaded over **HTTPS** (https://codebase-19.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://codebase-19.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://codebase-19.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://codebase-19.preview.emergentagent.com/api" ✅
...
### 1. Test Admin Login
1. Navigate to: `https://codebase-19.preview.emergentagent.com/admin/login`
2. Enter credentials:
   - Username: `admin`
   - Password: `admin123`
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://codebase-19.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://codebase-19.preview.emergentagent.com
- Admin Panel: https://codebase-19.preview.emergentagent.com/admin/login

...
- Frontend was loaded over **HTTPS** (https://webcode-deploy.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://webcode-deploy.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://webcode-deploy.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://webcode-deploy.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://webcode-deploy.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://webcode-deploy.preview.emergentagent.com
- Admin Panel: https://webcode-deploy.preview.emergentagent.com/admin/login
